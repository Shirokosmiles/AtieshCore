...
INSERT INTO `trinity_string` VALUES
(11511,'Stormwind',NULL,'Hurlevent',NULL,NULL,NULL,NULL,NULL,'Штормград');

-- LANG_ITEM_ORGRIMMAR
DELETE FROM `trinity_string` WHERE entry = 11512;
INSERT INTO `trinity_string` VALUES
(11512,'Orgrimmar',NULL,'Orgrimmar',NULL,NULL,NULL,NULL,NULL,'Оргриммар');
...
INSERT INTO `trinity_string` VALUES
(11515,'VIP Account menu',NULL,'Menu du compte VIP',NULL,NULL,NULL,NULL,NULL,'Управление Вип Аккаунтом');

-- LANG_ITEM_SERVER_MENU
DELETE FROM `trinity_string` WHERE entry = 11516;
INSERT INTO `trinity_string` VALUES
(11516,'Server information',NULL,'Informations sur le serveur',NULL,NULL,NULL,NULL,NULL,'Информация о сервере');

-- LANG_ITEM_VIP_BUY
DELETE FROM `trinity_string` WHERE entry = 11517;
INSERT INTO `trinity_string` VALUES
(11517,'buy VIP time',NULL,'Acheter du temps VIP',NULL,NULL,NULL,NULL,NULL,'Купить');

-- LANG_ITEM_VIP_INCREASE
DELETE FROM `trinity_string` WHERE entry = 11518;
INSERT INTO `trinity_string` VALUES
(11518,'increase VIP time',NULL,'Augmenter le temps VIP',NULL,NULL,NULL,NULL,NULL,'Увеличить время действий привилегий');

-- LANG_ITEM_CLOSE
DELETE FROM `trinity_string` WHERE entry = 11519;
INSERT INTO `trinity_string` VALUES
(11519,'Close',NULL,'Fermer',NULL,NULL,NULL,NULL,NULL,'Закрыть');
...
INSERT INTO `trinity_string` VALUES
(11521,'List of available commands',NULL,'Liste des commandes disponibles',NULL,NULL,NULL,NULL,NULL,'Список доступных комманд');

-- LANG_ITEM_CHARACTER_MANAGMENT
DELETE FROM `trinity_string` WHERE entry = 11522;
INSERT INTO `trinity_string` VALUES
(11522,'Character management',NULL,'Gérer le personnage',NULL,NULL,NULL,NULL,NULL,'Управление Персонажем');

-- LANG_ITEM_CHARACTER_CHANGEING
DELETE FROM `trinity_string` WHERE entry = 11523;
INSERT INTO `trinity_string` VALUES
(11523,'Changing the character',NULL,'Changer le personnage',NULL,NULL,NULL,NULL,NULL,'Изменение персонажа');

-- LANG_ITEM_CLASS_SKILLS
DELETE FROM `trinity_string` WHERE entry = 11524;
INSERT INTO `trinity_string` VALUES
(11524,'Class skills',NULL,'Compétences de classe',NULL,NULL,NULL,NULL,NULL,'Классовые навыки');

-- LANG_ITEM_REPAIR_EQUIP
DELETE FROM `trinity_string` WHERE entry = 11525;
INSERT INTO `trinity_string` VALUES
(11525,'Repair all equipment',NULL,'Réparer tous les équipements',NULL,NULL,NULL,NULL,NULL,'Починить всю экипировку');

-- LANG_ITEM_REMOVE_DESERTER
DELETE FROM `trinity_string` WHERE entry = 11526;
INSERT INTO `trinity_string` VALUES
(11526,'Remove Deserter',NULL,'Supprimer le débuff Déserteur',NULL,NULL,NULL,NULL,NULL,'Снять Дезертира');

-- LANG_ITEM_REMOVE_WEAKNESS
DELETE FROM `trinity_string` WHERE entry = 11527;
INSERT INTO `trinity_string` VALUES
(11527,'Remove Weakness',NULL,'Supprimer le débuff Faiblesse',NULL,NULL,NULL,NULL,NULL,'Снять Слабость');

-- LANG_ITEM_GIVE_BUFFS
DELETE FROM `trinity_string` WHERE entry = 11528;
INSERT INTO `trinity_string` VALUES
(11528,'Get the buffs',NULL,'Obtenez les buffs',NULL,NULL,NULL,NULL,NULL,'Получить баффы');

-- LANG_ITEM_REMOVE_COOLDOWN
DELETE FROM `trinity_string` WHERE entry = 11529;
INSERT INTO `trinity_string` VALUES
(11529,'Remove spell cooldowns',NULL,'Supprimer les temps de recharge des sorts',NULL,NULL,NULL,NULL,NULL,'Сбросить КД на способности');

-- LANG_ITEM_DUAL_SPEC
DELETE FROM `trinity_string` WHERE entry = 11530;
INSERT INTO `trinity_string` VALUES
(11530,'Dual specialization',NULL,'Double spécialisation',NULL,NULL,NULL,NULL,NULL,'Двойная специализация');

-- LANG_ITEM_RESET_TALENT
DELETE FROM `trinity_string` WHERE entry = 11531;
INSERT INTO `trinity_string` VALUES
(11531,'Reset talents',NULL,'Réinitialiser vos talents',NULL,NULL,NULL,NULL,NULL,'Сброс талантов');
...
INSERT INTO `trinity_string` VALUES
(11533,'Skills weapon',NULL,'Compétences d\'armes',NULL,NULL,NULL,NULL,NULL,'Оружейные навыки');

-- LANG_ITEM_MAXSKILL
DELETE FROM `trinity_string` WHERE entry = 11534;
INSERT INTO `trinity_string` VALUES
(11534,'Improve skills of protecting and owning weapons to the maximum',NULL,'Améliorer les compétences de protection et de possession de type d\'armes au maximum',NULL,NULL,NULL,NULL,NULL,'Улучшить навыки защиты и владения оружием до максимума');
...
INSERT INTO `trinity_string` VALUES
(11541,'Change name',NULL,'Changer de nom',NULL,NULL,NULL,NULL,NULL,'Смена имени');

-- LANG_ITEM_CHANGE_OF_APPEARANCE
DELETE FROM `trinity_string` WHERE entry = 11542;
INSERT INTO `trinity_string` VALUES
(11542,'Change of appearance',NULL,'Changer d\'apparence',NULL,NULL,NULL,NULL,NULL,'Смена внешности');

-- LANG_ITEM_CHANGE_FACTION
DELETE FROM `trinity_string` WHERE entry = 11543;
INSERT INTO `trinity_string` VALUES
(11543,'Change faction',NULL,'Changer de faction',NULL,NULL,NULL,NULL,NULL,'Смена фракции');
...
INSERT INTO `trinity_string` VALUES
(11545,'Rates:',NULL,'Taux',NULL,NULL,NULL,NULL,NULL,'Рейты:');

-- LANG_ITEM_RATES_XP_KILL
DELETE FROM `trinity_string` WHERE entry = 11546;
INSERT INTO `trinity_string` VALUES
(11546,'Rates XP for kill:',NULL,'Taux d\'XP des ennemis tués:',NULL,NULL,NULL,NULL,NULL,'Рейты на опыт за убийство:');

-- LANG_ITEM_RATES_XP_QUEST
DELETE FROM `trinity_string` WHERE entry = 11547;
INSERT INTO `trinity_string` VALUES
(11547,'Rates XP for quest:',NULL,'Taux d\'XP des quêtes:',NULL,NULL,NULL,NULL,NULL,'Рейты на опыт за задания:');

-- LANG_ITEM_RATES_REP
DELETE FROM `trinity_string` WHERE entry = 11548;
INSERT INTO `trinity_string` VALUES
(11548,'Rate of reputation:',NULL,'Taux de réputation:',NULL,NULL,NULL,NULL,NULL,'Рейт репутации:');

-- LANG_ITEM_RATES_GOLD
DELETE FROM `trinity_string` WHERE entry = 11549;
INSERT INTO `trinity_string` VALUES
(11549,'Rate of gold:',NULL,'Taux d\'argent:',NULL,NULL,NULL,NULL,NULL,'Рейт золота:');

-- LANG_ITEM_RATES_HONOR
DELETE FROM `trinity_string` WHERE entry = 11550;
INSERT INTO `trinity_string` VALUES
(11550,'Rate of honor:',NULL,'Taux d\'honneur:',NULL,NULL,NULL,NULL,NULL,'Рейт Хонора:');
