...
(6, 2, 5, 5, 'Horde Auction House', '', '', 'Hôtel des ventes de la Horde', 'Auktionshaus der Horde', '', '部落拍卖行', '', '', 'Casa de subastas: Horda', '', 'Аукционный дом Орды', '', '', '', '', 16712190),
(7, 369, 25, 15, 'Blackwater Auction House', '', '', 'Hôtel des ventes des Flots noirs', 'Auktionshaus der Schwarzmeerräuber', '', '黑水拍卖行', '', '', 'Casa de subastas: Aguasnegras', '', 'Аукционный дом Черноводья', '', '', '', '', 16712190);
