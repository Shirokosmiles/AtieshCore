-- ----------------------------
-- Table structure for dbc_scalingstatvalues
-- ----------------------------
DROP TABLE IF EXISTS `dbc_scalingstatvalues`;
CREATE TABLE `dbc_scalingstatvalues`  (
...
-- ----------------------------
-- Records of dbc_scalingstatvalues
-- ----------------------------
INSERT INTO `dbc_scalingstatvalues` VALUES
