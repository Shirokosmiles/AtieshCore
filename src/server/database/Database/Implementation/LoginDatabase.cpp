...
void LoginDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(LOGIN_INS_GM_CHAR_ITEM_ADD, "INSERT INTO account_gm_log_item (id, time, guid, player, account, item, item_guid, count, position, target, realmId) VALUES (?, NOW(), ?, ?, ?, ?, ?, ?, ?, ?, ?)", CONNECTION_ASYNC);
    PrepareStatement(LOGIN_INS_GM_CHAR_LOG, "INSERT INTO account_gm_log (id, time, player, account, command, position, selected, realmId) VALUES (?, NOW(), ?, ?, ?, ?, ?, ?)", CONNECTION_ASYNC);
 }
