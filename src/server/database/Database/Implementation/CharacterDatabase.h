...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_INS_INSTANCE_WEB_SAVE,
    CHAR_UPD_INSTANCE_WEB_DATA,
    CHAR_DEL_INSTANCE_WEB_DATA,
    ...
    // for guild_wars_history
    CHAR_INS_GUILD_WAR_START_HISTORY,
    CHAR_UPD_GUILD_WAR_STOP_HISTORY,
