...
DoorData const doorData[] =
{
    ...
    { GO_ILLIDAN_GATE,          DATA_AKAMA,                 DOOR_TYPE_PASSAGE },
...
public:
    ...
    class spell_black_template_harpooners_mark_AuraScript : public AuraScript
    {
        ...
        void HandleEffectApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
        {
            ...
            GetUnitOwner()->GetCreatureListWithEntryInGrid(creatureList, 80.0f, NPC_DRAGON_TURTLE);
        ...
        {
            for (std::set<ObjectGuid>::const_iterator itr = _turtleSet.begin(); itr != _turtleSet.end(); ++itr)
