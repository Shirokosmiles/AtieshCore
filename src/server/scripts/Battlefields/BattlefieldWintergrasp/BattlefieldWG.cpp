...
bool BattlefieldWintergrasp::SetupBattlefield(bool active, bool enabled, uint32 id, uint32 cooldownTimer, uint32 durationTimer, uint32 minlevel, uint32 maxplayers, uint32 controlteam, uint32 remainingtime)
{
    // override Setup for Set time of first run in cooldownTimer
    if (!Battlefield::SetupBattlefield(active, enabled, id, cooldownTimer, durationTimer, minlevel, maxplayers, controlteam, remainingtime))
        return false;
...
class Battlefield_BattlefieldWintergrasp : public BattlefieldScript
{
public:
    Battlefield_BattlefieldWintergrasp() : BattlefieldScript("Wintergrasp") { }
...
{
    new Battlefield_BattlefieldWintergrasp();
}
