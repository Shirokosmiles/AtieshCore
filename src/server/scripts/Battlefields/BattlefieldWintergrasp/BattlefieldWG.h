...
class TC_GAME_API BattlefieldWintergrasp : public Battlefield
{
    public:
        ...
        bool SetupBattlefield(bool active, bool enabled, uint32 id, uint32 cooldownTimer, uint32 durationTimer, uint32 minlevel, uint32 maxplayers, uint32 controlteam, uint32 remainingtime) override;
