...
enum TransmogTrinityStrings // Language.h might have same entries, appears when executing SQL, change if needed
{
    ...
    LANG_MANAGE_SETS, // |TInterface/RAIDFRAME/UI-RAIDFRAME-MAINASSIST:30:30:-18:0|tManage sets
    LANG_HOW_SETS_WORKS, // |TInterface/ICONS/INV_Misc_Book_11:30:30:-18:0|tHow sets work
    LANG_SAVE_SET, // |TInterface/GuildBankFrame/UI-GuildBankFrame-NewTab:30:30:-18:0|tSave set
    LANG_SAVE_SET_NAME, // Insert set name
    ...
    LANG_BIND_ITEM, // Using this item for transmogrify will bind it to you and make it non-refundable and non-tradeable.\nDo you wish to continue?\n\n
#endif
};
