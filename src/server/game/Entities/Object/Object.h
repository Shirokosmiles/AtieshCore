...
class TC_GAME_API WorldObject : public Object, public WorldLocation
{
    ...
    public:
        ...
        TempSummon* SummonCreature(uint32 entry, Position const& pos, TempSummonType despawnType = TEMPSUMMON_MANUAL_DESPAWN, uint32 despawnTime = 0, uint32 vehId = 0, uint32 spellId = 0, GameObject* GOsummoner = nullptr);
        TempSummon* SummonCreature(uint32 entry, Position const& pos, TempSummonType despawnType, Milliseconds despawnTime, uint32 vehId = 0, uint32 spellId = 0, GameObject* GOsummoner = nullptr) { return SummonCreature(entry, pos, despawnType, uint32(despawnTime.count()), vehId, spellId, GOsummoner); }
        TempSummon* SummonCreature(uint32 entry, float x, float y, float z, float o = 0, TempSummonType despawnType = TEMPSUMMON_MANUAL_DESPAWN, uint32 despawnTime = 0, GameObject* GOsummoner = nullptr);
        ...
        virtual float GetCollisionHeight() const { return 2.0f; }
