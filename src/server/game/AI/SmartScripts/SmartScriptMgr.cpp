...
bool SmartAIMgr::IsEventValid(SmartScriptHolder& e)
{
    ...
    else
    {
        switch (e.GetEventType())
        {
            ...
            case SMART_EVENT_IS_BEHIND_TARGET:
                FMT_LOG_ERROR("sql.sql", "SmartAIMgr: Unused event_type({}), Entry {} SourceType {} Event {}, skipped.", e.GetEventType(), e.entryOrGuid, e.GetScriptType(), e.event_id);
                return false;
            default:
    ...
    switch (e.GetActionType())
    {
        ...
        case SMART_ACTION_REMOVE_DYNAMIC_FLAG:
            FMT_LOG_ERROR("sql.sql", "SmartAIMgr: Unused action_type({}), event_type({}), Entry {} SourceType {} Event {}, skipped.", e.GetActionType(), e.GetEventType(), e.entryOrGuid, e.GetScriptType(), e.event_id);
            return false;
        default:
