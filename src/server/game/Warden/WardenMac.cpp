...
void WardenMac::Init(WorldSession* pClient, SessionKey const& K)
{
    ...
    */
    ...
    FMT_LOG_DEBUG("warden", "Server side warden for client {} initializing...", pClient->GetAccountId());
...
{
    FMT_LOG_DEBUG("warden", "Request data");
...
void WardenMac::HandleCheckResult(ByteBuffer &buff)
{
    ...
    {
        FMT_LOG_DEBUG("warden", "Handle data failed: SHA1 hash is wrong!");
        //found = true;
    }
    ...
    {
        FMT_LOG_DEBUG("warden", "Handle data failed: MD5 hash is wrong!");
        //found = true;
    }
