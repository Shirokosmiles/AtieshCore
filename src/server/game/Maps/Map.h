...
class TC_GAME_API Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        bool IsSwimmable(float x, float y, float z, float radius, LiquidData* data = nullptr) const;
...
{
    public:
        InstanceMap(uint32 id, time_t, uint32 InstanceId, uint8 SpawnMode, Map* _parent, uint32 InstanceTeam);
        ~InstanceMap();
        ...
        uint32 GetPlayersTeam() const { return i_script_team; }
