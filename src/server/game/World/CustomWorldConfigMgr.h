...
#ifndef _CUSTOM_GAME_CONFIG_H
#define _CUSTOM_GAME_CONFIG_H
...
private:
    // Add config options
    void AddOption(CustomWorldConfigType type, uint32 IDinTypeGroup, std::string const& defaultValue, std::string const& value);
