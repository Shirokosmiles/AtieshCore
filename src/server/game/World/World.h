...
enum CustomWorldBoolConfigs
{
    ...
    CONFIG_ALLOW_LFG_CHANNEL_EVERYWHERE,
    CONFIG_ALLOW_TWO_SIDE_INTERACTION_LFG_GROUP,
    CONFIG_MAIL_ANTISPAM_ENABLED,
    CONFIG_MAIL_EXTERNAL_ENABLED,
    CONFIG_PLAYER_AUTO_LEARN_ENABLED,
    CONFIG_PLAYER_UNIVERSAL_LANGUAGE_ENABLED,
    CONFIG_PLAYER_PVPCAP_REWARD_ENABLED,
    CONFIG_PLAYER_DUEL_PHASE_ENABLED,
    CONFIG_PLAYER_BONUS_BAGS_ENABLED,
    CONFIG_PLAYER_BONUS_STARTPACK_ENABLED,
    CONFIG_PLAYER_FIRST_LOGIN_ACC_BONUS_ENABLED,
    CONFIG_RAID_INFO_ENABLED,
...
enum CustomWorldFloatConfigs {
    CUSTOM_FLOAT_CONFIG_VALUE_COUNT = 1
};

enum CustomWorldIntConfigs {
    CONFIG_VANISH_VISION_TIMER = 0,
...
class TC_GAME_API World
{
    ...
    private:
        ...
        float custom_rate_values[CUSTOM_MAX_RATES];
