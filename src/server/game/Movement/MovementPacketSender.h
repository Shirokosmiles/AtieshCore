...
#ifndef MovementPacketSender_h__
#define MovementPacketSender_h__
...
{
    /* height change */
    void SendHeightChangeToMover(Unit* unit, float newRate);
    void SendHeightChangeToObservers(Unit* unit, float newRate);

    /* teleport */
    void SendTeleportAckPacket(Unit* unit, MovementInfo const& movementInfo); // rename to SendTeleportToMover?
    void SendTeleportPacket(Unit* unit, MovementInfo const& movementInfo); // rename to SendTeleportToobservers?
    ...
    void SendMovementFlagChangeToMover(Unit* unit, MovementFlags2 mFlag, bool apply);
    void SendMovementFlagChangeToObservers(Unit* unit, MovementFlags mFlag, bool apply);
    void SendMovementFlagChangeToObservers(Unit* unit, MovementFlags2 mFlag);
...
#endif // MovementPacketSender_h__
