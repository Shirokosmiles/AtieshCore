...
{    
    { BG_BE_OBJECT_TYPE_DOOR_1, { 6287.277f, 282.1877f, 3.810925f, -2.26019700f }, { 0.f, 0.f, -0.90445420f, 0.4265707f }, RESPAWN_IMMEDIATELY },// gates
    ...
    { BG_BE_OBJECT_TYPE_BUFF_1, { 6249.042f, 275.3239f, 11.22033f, -1.44862200f }, { 0.f, 0.f, -0.66261960f, 0.7489561f }, 2 * MINUTE          },// buffs
