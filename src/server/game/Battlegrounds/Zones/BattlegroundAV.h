...
class BattlegroundAV : public Battleground
{
    ...
    private:
        ...
        /*variables */
        int32 m_Team_Scores[PVP_TEAMS_COUNT];
        ...
        uint32 m_CaptainBuffTimer[PVP_TEAMS_COUNT];
        bool m_CaptainAlive[PVP_TEAMS_COUNT];

        bool m_IsInformedNearVictory[PVP_TEAMS_COUNT];
};
