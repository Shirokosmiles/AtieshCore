...
{
    FMT_LOG_DEBUG("network", "MSG_INSPECT_ARENA_TEAMS");

    ObjectGuid guid;
    recvData >> guid;
    FMT_LOG_DEBUG("network", "Inspect Arena stats {}", guid.ToString());
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_QUERY");
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_ROSTER");
...
{
    FMT_LOG_DEBUG("network", "CMSG_ARENA_TEAM_INVITE");
    ...
    FMT_LOG_DEBUG("bg.battleground", "Player {} Invited {} to Join his ArenaTeam", GetPlayer()->GetName(), invitedName);
    ...
    FMT_LOG_DEBUG("network", "WORLD: Sent SMSG_ARENA_TEAM_INVITE");
}

void WorldSession::HandleArenaTeamAcceptOpcode(WorldPacket & /*recvData*/)
{
    FMT_LOG_DEBUG("network", "CMSG_ARENA_TEAM_ACCEPT");                // empty opcode
...
{
    FMT_LOG_DEBUG("network", "CMSG_ARENA_TEAM_DECLINE");               // empty opcode
...
{
    FMT_LOG_DEBUG("network", "CMSG_ARENA_TEAM_LEAVE");
...
{
    FMT_LOG_DEBUG("network", "CMSG_ARENA_TEAM_DISBAND");
...
{
    FMT_LOG_DEBUG("network", "CMSG_ARENA_TEAM_REMOVE");
...
{
    FMT_LOG_DEBUG("network", "CMSG_ARENA_TEAM_LEADER");
