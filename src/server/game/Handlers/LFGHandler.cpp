...
void WorldSession::HandleLfgJoinOpcode(WorldPackets::LFG::LFGJoin& packet)
{
    ...
    {
        FMT_LOG_DEBUG("lfg", "CMSG_LFG_JOIN {} no dungeons selected", GetPlayerInfo());
        return;
    }
    ...
    FMT_LOG_DEBUG("lfg", "CMSG_LFG_JOIN {} roles: {}, Dungeons: {}, Comment: {}",
...
void WorldSession::HandleLfgLeaveOpcode(WorldPackets::LFG::LFGLeave& /*packet*/)
{
    ...
    FMT_LOG_DEBUG("lfg", "CMSG_LFG_LEAVE {} in group: {}",
...
void WorldSession::HandleLfgProposalResultOpcode(WorldPacket& recvData)
{
    ...
    FMT_LOG_DEBUG("lfg", "CMSG_LFG_PROPOSAL_RESULT {} proposal: {} accept: {}",
...
void WorldSession::HandleLfgSetRolesOpcode(WorldPacket& recvData)
{
    ...
    if (!group)
    {
        FMT_LOG_DEBUG("lfg", "CMSG_LFG_SET_ROLES {} Not in group",
            GetPlayerInfo());
        return;
    }
    ObjectGuid gguid = group->GetGUID();
    FMT_LOG_DEBUG("lfg", "CMSG_LFG_SET_ROLES: Group {}, Player {}, Roles: {}",
...
void WorldSession::HandleLfgSetCommentOpcode(WorldPacket& recvData)
{
    ...
    FMT_LOG_DEBUG("lfg", "CMSG_LFG_SET_COMMENT {} comment: {}",
...
void WorldSession::HandleLfgSetBootVoteOpcode(WorldPacket& recvData)
{
    ...
    ObjectGuid guid = GetPlayer()->GetGUID();
    FMT_LOG_DEBUG("lfg", "CMSG_LFG_SET_BOOT_VOTE {} agree: {}",
...
void WorldSession::HandleLfgTeleportOpcode(WorldPacket& recvData)
{
    ...
    FMT_LOG_DEBUG("lfg", "CMSG_LFG_TELEPORT {} out: {}",
...
{
    ObjectGuid guid = GetPlayer()->GetGUID();
    FMT_LOG_DEBUG("lfg", "CMSG_LFG_PLAYER_LOCK_INFO_REQUEST {}",
        GetPlayerInfo());
    ...
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_PLAYER_INFO {}", GetPlayerInfo());
...
{
    ObjectGuid guid = GetPlayer()->GetGUID();
    FMT_LOG_DEBUG("lfg", "CMSG_LFG_PARTY_LOCK_INFO_REQUEST {}", GetPlayerInfo());
    ...
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_PARTY_INFO {}", GetPlayerInfo());
...
void WorldSession::HandleLfrJoinOpcode(WorldPacket& recvData)
{
    ...
    recvData >> entry;
    FMT_LOG_DEBUG("lfg", "CMSG_LFG_LFR_JOIN {} dungeon entry: {}",
        GetPlayerInfo(), entry);
...
void WorldSession::HandleLfrLeaveOpcode(WorldPacket& recvData)
{
    ...
    recvData >> dungeonId;
    FMT_LOG_DEBUG("lfg", "CMSG_LFG_LFR_LEAVE {} dungeonId: {}",
...
{
    FMT_LOG_DEBUG("lfg", "CMSG_LFG_GET_STATUS {}", GetPlayerInfo());
...
void WorldSession::SendLfgUpdatePlayer(lfg::LfgUpdateData const& updateData)
{
    ...
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_UPDATE_PLAYER {} updatetype: {}",
...
void WorldSession::SendLfgUpdateParty(const lfg::LfgUpdateData& updateData)
{
    ...
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_UPDATE_PARTY {} updatetype: {}",
        GetPlayerInfo(), updateData.updateType);
...
{
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_ROLE_CHOSEN {} guid: {} roles: {}",
...
void WorldSession::SendLfgRoleCheckUpdate(lfg::LfgRoleCheck const& roleCheck)
{
    ...
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_ROLE_CHECK_UPDATE {}", GetPlayerInfo());
...
void WorldSession::SendLfgJoinResult(lfg::LfgJoinResultData const& joinData)
{
    ...
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_JOIN_RESULT {} checkResult: {} checkValue: {}",
...
{
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_QUEUE_STATUS {} state: {}, dungeon: {}, waitTime: {}, "
...
void WorldSession::SendLfgPlayerReward(lfg::LfgPlayerRewardData const& rewardData)
{
    ...
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_PLAYER_REWARD {} rdungeonEntry: {}, sdungeonEntry: {}, done: {}",
...
void WorldSession::SendLfgBootProposalUpdate(lfg::LfgPlayerBoot const& boot)
{
    ...
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_BOOT_PROPOSAL_UPDATE {} inProgress: {} - "
...
void WorldSession::SendLfgUpdateProposal(lfg::LfgProposal const& proposal)
{
    ...
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_PROPOSAL_UPDATE {} state: {}",
...
{
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_LFR_LIST {} update: {}",
...
{
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_DISABLED {}", GetPlayerInfo());
...
{
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_OFFER_CONTINUE {} dungeon entry: {}",
...
{
    FMT_LOG_DEBUG("lfg", "SMSG_LFG_TELEPORT_DENIED {} reason: {}",
        GetPlayerInfo(), err);
...
{
    FMT_LOG_DEBUG("network", "SMSG_LFG_UPDATE_LIST {} dungeon entry: {}",
        GetPlayerInfo(), dungeonEntry);
