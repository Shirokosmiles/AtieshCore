...
void WorldSession::HandleDuelAcceptedOpcode(WorldPacket& recvPacket)
{
    ...
    //FMT_LOG_DEBUG("network", "WORLD: Received CMSG_DUEL_ACCEPTED");
    FMT_LOG_DEBUG("network", "Player 1 is: {} ({})", player->GetGUID().ToString(), player->GetName());
    FMT_LOG_DEBUG("network", "Player 2 is: {} ({})", target->GetGUID().ToString(), target->GetName());
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_DUEL_CANCELLED");
    Player* player = GetPlayer();
