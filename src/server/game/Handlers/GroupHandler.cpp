...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_INVITE");
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_ACCEPT");
    ...
    {
        FMT_LOG_ERROR("network", "HandleGroupAcceptOpcode: player {} {} tried to accept an invite to his own group", GetPlayer()->GetName(), GetPlayer()->GetGUID().ToString());
        return;
    }
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_DECLINE");
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_UNINVITE_GUID");
    ...
    {
        FMT_LOG_ERROR("network", "WorldSession::HandleGroupUninviteGuidOpcode: leader {} {} tried to uninvite himself from the group.",
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_UNINVITE");
    ...
    {
        FMT_LOG_ERROR("network", "WorldSession::HandleGroupUninviteOpcode: leader {} {} tried to uninvite himself from the group.",
            GetPlayer()->GetName(), GetPlayer()->GetGUID().ToString());
        return;
    }
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_SET_LEADER");
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_DISBAND");
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_LOOT_METHOD");
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received MSG_MINIMAP_PING");
    ...
    //FMT_LOG_DEBUG("Received opcode MSG_MINIMAP_PING X: {}, Y: {}", x, y);
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received MSG_RAID_TARGET_UPDATE");
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_RAID_CONVERT");
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_CHANGE_SUB_GROUP");
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_ASSISTANT_LEADER");
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received MSG_PARTY_ASSIGNMENT");
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received MSG_RAID_READY_CHECK");
...
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_REQUEST_PARTY_MEMBER_STATS");
    ObjectGuid Guid;
    recvData >> Guid;
...
{
    FMT_LOG_DEBUG("WORLD: got CMSG_GROUP_CANCEL.");
}*/

void WorldSession::HandleOptOutOfLootOpcode(WorldPacket& recvData)
{
    FMT_LOG_DEBUG("network", "WORLD: Received CMSG_OPT_OUT_OF_LOOT");
    ...
    {
        if (passOnLoot != 0)
            FMT_LOG_ERROR("network", "CMSG_OPT_OUT_OF_LOOT value<>0 for not-loaded character!");
        return;
    }
