...
#ifdef TRINITY
#define ELUNA_LOG_INFO(...)     FMT_LOG_INFO("eluna", __VA_ARGS__);
#define ELUNA_LOG_ERROR(...)    FMT_LOG_ERROR("eluna", __VA_ARGS__);
#define ELUNA_LOG_DEBUG(...)    FMT_LOG_DEBUG("eluna", __VA_ARGS__);
...
namespace ElunaUtil
{
    ...
    public:
        ...
        FactionTemplateDBC const* i_obj_fact;
