...
ElunaRegister<AuctionHouseDBC> AuctionMethods[] =
{
    { NULL, NULL }
};
...
void RegisterFunctions(Eluna* E)
{
    ...
    ElunaTemplate<AuctionHouseDBC>::Register(E, "AuctionHouseEntry");
    ElunaTemplate<AuctionHouseDBC>::SetMethods(E, AuctionMethods);
